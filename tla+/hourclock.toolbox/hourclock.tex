...
\fl{}\moduleLeftDash\cl{ {\MODULE} hourclock}\moduleRightDash\cl{}
\fl{ {\EXTENDS} naturals}
\fl{ {\VARIABLE} hr}
\fl{ HCini}\al{3}{1}{ \.{\defeq}}\al{3}{2}{ hr \.{\in} ( 1 \.{\dotdot} 12 )}
 \fl{ HCnxt}\al{4}{1}{ \.{\defeq}}\al{4}{2}{ hr \.{'} \.{=} {\IF} hr \.{\neq}
 12 \.{\THEN} hr \.{+} 1 \.{\ELSE} 1}
\fl{ HC \.{\defeq} HCini \.{\land} {\Box} [ HCnxt ]_{ hr}}
\fl{}\midbar\cl{}
